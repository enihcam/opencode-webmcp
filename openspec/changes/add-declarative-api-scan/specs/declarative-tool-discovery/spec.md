...
Discovery of WebMCP tools declared via HTML form annotations (`toolname`, `toolname-target` attributes) rather than imperative `document.modelContext.registerTool()` calls.
