...
External configuration of the webmcp-bridge via CLI args, config file (YAML/JSON), or environment variables. Layered precedence: defaults → env vars → config file → CLI args.
